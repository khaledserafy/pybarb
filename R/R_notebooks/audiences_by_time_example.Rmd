...
This code uses your account details to get an access token from the API. Create a text file named `creds.json`. The file should include the email and password supplied by BARB. For example:
